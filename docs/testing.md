...
Every push runs 46 of the 47 workflows in real n8n (P10 is structure-checked), with credentialed and AI nodes replaced by fixtures and 98 behaviour checks. See [tests/README.md](../tests/README.md).
