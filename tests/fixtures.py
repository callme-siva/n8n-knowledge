...
TRIGGERS = {
    ...
    "L14-ai-agent-with-tools": [{"chatInput": "What's 18% VAT on 12499?", "sessionId": "s1"}],
    ...
    "P06-purchase-approval-multilevel": [{"Your email": "req@example.com", "Item / service": "MacBook Pro", "Amount (USD)": "2400", "Cost centre": "Engineering", "Justification": "Laptop replacement"}],
...
FIXTURES = {
    ...
    "L14-ai-agent-with-tools": {"Assistant Agent": AI(output="18% VAT on $12,499 is $2,249.82.")},
